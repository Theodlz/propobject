...
class BaseFitter( BaseObject ):
    ...
    def _fit_minuit_(self,verbose=False, step=1):
        ...
        self._fitparams = np.asarray([values[k]
    ...
    def _setup_minuit_(self, step=1, print_level=0):
        ...
        for param in self.model.FREEPARAMETERS:
            ...
            limits[param] = self.param_input["%s_boundaries"%param]
            fixed[param]  = self.param_input["%s_fixed"%param]

        self.minuit = Minuit(self.model._minuit_chi2_, **values)
